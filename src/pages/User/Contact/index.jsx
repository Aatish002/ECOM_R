...
const Contactform = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mt-10 w-full max-w-5xl mx-auto text-base sm:text-lg">
        ...
        <div className="w-full">
          ...
          {errors.contactMessage && (
            <p className="mt-2 text-red-500">{errors.contactMessage.message}</p>
          )}
        </div>
        ...
        <button
          ...
          className="bg-yellow-500 text-black px-6 py-3 mt-6 rounded hover:bg-yellow-400 transition-all duration-300 w-full sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed"
        >
